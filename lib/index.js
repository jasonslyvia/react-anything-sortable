...
/***/ function(module, exports, __webpack_require__) {
	...
	function _handleSortableItemReadyToMove(e) {
	  ...
	  if (this.props.sortHandle && e.target.className.indexOf(this.props.sortHandle) === -1) {
	    return;
	  }
	  ...
	  if (Component) {
	    return (function (_React$Component) {
	      ...
	      SortableItem.prototype.render = function render() {
	        ...
	        var rest = _objectWithoutProperties(_props, ['sortableClassName', 'sortableStyle', 'sortableIndex', 'sortHandle']);

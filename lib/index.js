...
/***/ function(module, exports, __webpack_require__) {
	...
	function _handleSortableItemReadyToMove(e) {
	  ...
	  if (this.props.sortHandleClass && e.target.className.indexOf(this.props.sortHandleClass) === -1) {
	    return;
	  }
	  ...
	  if (Component) {
	    return (function (_React$Component) {
	      ...
	      SortableItem.prototype.render = function render() {
	        ...
	        return _react2['default'].createElement(Component, _extends({}, rest, { className: sortableClassName,
